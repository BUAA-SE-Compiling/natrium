...
;(function codeSnippets() {
  ...
  if (window.ace) {
    ...
    Array.from(document.querySelectorAll('code.editable')).forEach(function(block) {
      block.classList.remove('language-rust')
    })

    Array.from(document.querySelectorAll('code:not(.editable)')).forEach(function(block) {
...
;(function themes() {
  ...
  var stylesheets = {
    cityLights: document.querySelector("[href$='city-lights-highlight.css']"),
...
;(function sidebar() {
  ...
  function resize(e) {
    document.documentElement.style.setProperty(
      '--sidebar-width',
      e.clientX - sidebar.offsetLeft + 'px'
    )
  }
